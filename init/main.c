...
asmlinkage __visible void __init __no_sanitize_address start_kernel(void)
{
	...
	setup_nr_cpu_ids();
	/*xiaojin-percpu -0.0 setup_per_cpu_areas*/
	setup_per_cpu_areas();
...
static noinline void __init kernel_init_freeable(void)
{
	...
	/*xiaojin-percpu_kthread_cpu0_run.入口1 这是是初始化SMP的地方。BSP到AP的过程。比percpu kthread要早。*/
	...
	page_ext_init();
	/*xiaojin-percpu_kthread_cpu0_run.入口2 init percpu kthread的地方 start_kernel->arch_call_rest_init->rest_init->kernel_init->kernel_init_freeable->do_basic_setup*/
	do_basic_setup();

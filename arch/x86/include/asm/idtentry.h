...
/** xiaojin-DEFINE_IDTENTRY_IRQ 生成IDT表函数的宏 interrupt
...
/*xiaojin-interrupt_process -+2example DECLARE_IDTENTRY例子*/
...
#ifdef CONFIG_SMP
/*xiaojin RESCHEDULE_VECTOR sysvec_reschedule_ipi*/
/*xiaojin-interrupt-apic RESCHEDULE_VECTOR 注册ipi消息函数*/

...
void load_percpu_segment(int cpu)
{
	...
	/* xiaojin-percpu_kthread_cpu0_run.10 每个CPU在初始化的时候都会设置自身的gs寄存器，指向各自CPU的unit基地址。
 ...
 */
/*xiaojin current_task 指向当前在运行的task_struct*/
...
/*xiaojin-syscall-0.1 系统调用真正的入口——MSR寄存器用于保存
系统调用的入口地址。
